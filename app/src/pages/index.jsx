...
const navConfig = {
  left: [{ label: "suma", href: "/", icon: "Flower" }],
  center: [
    ...
    <>
      ...
      <div className="min-h-screen pb-10">
        <Hero
          title={
            <>
              <span>Build with Happiness using</span>{" "}
              <strong className="bg-gradient-to-r from-blue-600 via-green-500 to-red-400 text-transparent bg-clip-text">
                Suma
              </strong>
            </>
          }
          ...
          badgeText={
            <a
              href="https://github.com/aquaticcalf/suma"
